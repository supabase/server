...
| TanStack Start | `@supabase/server/adapters/tanstack-start` | `@tanstack/start-client-core ^1.170.0`, `@tanstack/start-server-core ^1.169.0` | [docs/adapters/tanstack-start.md](../../docs/adapters/tanstack-start.md) |
